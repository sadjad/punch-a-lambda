  ...
  event_loop.add_rule(
    ...
    [&] {
      ...
      event_loop.add_rule(
        ...
        *client_it,
        [&, client_it] {
          ...
          read_buffer_.read_from( *client_it );
        },
        [&] {
          std::cout << "http read " << std::endl;
        ...
        [&, client_it] {
          ...
          send_buffer_.write_to( *client_it );
        },
        [&] {
          std::cout << "http write " << std::endl;
      ...
      event_loop.add_rule(
        ...
        [&] {
          return read_buffer_.readable_region().length()
                 > (int)read_buffer_.readable_region()[0] - 1;
        } );
      ...
      event_loop.add_rule(
        ...
        [&] {
          return outbound_messages_.size() > 0
                 and not send_buffer_.writable_region().empty();
        } );
    },
    [&] { return true; } );
}
